...
class LostAndFoundFoundFormActivity:AppCompatActivity() {
    ...
    private lateinit var founderNameEditText: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lost_and_found_found_form)

        petNameEditText = findViewById(R.id.et_foundRForm_PetName)
        ageEditText = findViewById(R.id.et_foundRForm_Age)
        breedEditText = findViewById(R.id.et_foundRForm_Breed)
        typeEditText = findViewById(R.id.et_foundRForm_Type)
        genderRadioGroup = findViewById(R.id.rg_gender)
        descEditText = findViewById(R.id.et_foundRForm_Desc)
        founderNameEditText = findViewById(R.id.et_foundRForm_FounderName)
        cNumEditText = findViewById(R.id.et_foundRForm_CNum)
        locationEditText = findViewById(R.id.et_foundRForm_Location)
        reportButton = findViewById(R.id.btn_foundRForm)
        storageReference = FirebaseStorage.getInstance().reference
        firebaseDatabase = FirebaseDatabase.getInstance()

        // Set an OnClickListener for the ImageView to handle image uploads
        val imageView: ImageView = findViewById(R.id.iv_foundRF)
    ...
    private fun validate(): Boolean {
        ...
        if (petName.isEmpty() || age.isEmpty() || breed.isEmpty() || type.isEmpty() || genderRadioButtonId == -1 || description.isEmpty() || founderName.isEmpty() || contactNumber.isEmpty() || location.isEmpty() || selectedImageUri == null) {
    ...
    private fun saveDataToFirebase() {
        ...
        val databaseReference = firebaseDatabase.getReference("lost_and_found_found")
    ...
    private fun uploadImageToStorage(uniqueKey: String) {
        val imageRef = storageReference.child("found_images/$uniqueKey.jpg")
